package com.tianbo.smartcity.modules.base.controller.scocial;
...
import com.tianbo.smartcity.modules.base.vo.AccessToken;
import com.tianbo.smartcity.common.vo.Result;
import com.tianbo.smartcity.modules.base.vo.WeiboUserInfo;
import com.tianbo.smartcity.modules.base.entity.social.Weibo;
import com.tianbo.smartcity.modules.base.service.WeiboService;
...
@RequestMapping("/smartcity/social/weibo")
@Controller
public class WeiboController {

    @Value("${smartcity.social.weibo.appKey}")
    private String appKey;

    @Value("${smartcity.social.weibo.appSecret}")
    private String appSecret;

    @Value("${smartcity.social.weibo.callbackUrl}")
    private String callbackUrl;

    @Value("${smartcity.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${smartcity.social.callbackFeRelateUrl}")
