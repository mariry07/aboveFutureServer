...
import com.tianbo.smartcity.common.vo.EmailValidate;
...
@RequestMapping("/smartcity/email")
@Transactional
public class ValidateEmailController {
    ...
    public Result<Object> sendCodeEmail(@PathVariable String email,
        ...
        emailUtil.sendTemplateEmail(email, "【Smart City】修改邮箱验证", "code-email", e);
        // 请求成功 标记限流
    ...
    public Result<Object> sendResetCode(@RequestParam String email,
        ...
        emailUtil.sendTemplateEmail(email, "【Smart City】重置密码邮箱验证", "code-email", e);
        // 请求成功 标记限流
        redisTemplate.opsForValue().set(key, "sended", 1L, TimeUnit.MINUTES);
        return new ResultUtil<Object>().setData(null);
    }
