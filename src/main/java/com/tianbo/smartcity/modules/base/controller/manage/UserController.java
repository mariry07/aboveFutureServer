...
import com.tianbo.smartcity.modules.base.aync.AddMessage;
import com.tianbo.smartcity.common.constant.CommonConstant;
import com.tianbo.smartcity.common.enums.LogType;
...
import com.tianbo.smartcity.modules.base.service.*;
...
public class UserController {
    ...
    public Result<Object> smsLogin(@RequestParam String mobile,
        ...
        if (StrUtil.isBlank(v)) {
            throw new SmartCityException("验证码失效或KEY不正确");
        }
        if (!code.equals(v)) {
            throw new SmartCityException("验证码不正确");
        }
        User u = userService.findByMobile(mobile);
        if (u == null) {
            throw new SmartCityException("手机号不存在");
        }
    ...
    public Result<Object> delAllByIds(@PathVariable String[] ids) {
        ...
        for (String id : ids) {
            ...
            redisTemplate.delete(ThirdConstant.THIRD_ACCESS_KEY.getName() + u.getUsername());
            ...
            // 删除绑定第三方平台
            thirdPlatformService.deleteByUserId(id);
        }
