...
import com.tianbo.smartcity.modules.base.vo.VaptchaSetting;
...
import com.tianbo.smartcity.modules.base.service.GithubService;
import com.tianbo.smartcity.modules.base.service.QQService;
...
@RequestMapping("/smartcity/social")
@RestController
public class RelateController {
    ...
    public VaptchaSetting getVaptchaSetting() {
        ...
        if (StrUtil.isBlank(v)) {
            throw new SmartCityException("系统还未配置Vaptcha验证码");
        }
