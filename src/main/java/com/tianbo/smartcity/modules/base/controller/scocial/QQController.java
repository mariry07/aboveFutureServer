...
import com.tianbo.smartcity.modules.base.vo.QQUserInfo;
...
@RequestMapping("/smartcity/social/qq")
@Controller
public class QQController {

    @Value("${smartcity.social.qq.appId}")
    private String appId;

    @Value("${smartcity.social.qq.appKey}")
    private String appKey;

    @Value("${smartcity.social.qq.callbackUrl}")
