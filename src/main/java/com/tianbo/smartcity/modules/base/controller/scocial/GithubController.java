...
import com.tianbo.smartcity.modules.base.vo.GithubUserInfo;
...
@RequestMapping("/smartcity/social/github")
@Controller
public class GithubController {

    @Value("${smartcity.social.github.clientId}")
    private String clientId;

    @Value("${smartcity.social.github.clientSecret}")
    private String clientSecret;

    @Value("${smartcity.social.github.callbackUrl}")
