...
import com.tianbo.smartcity.modules.activiti.dao.ActProcessDao;
...
import com.tianbo.smartcity.modules.base.entity.DepartmentHeader;
import com.tianbo.smartcity.modules.base.entity.Role;
import com.tianbo.smartcity.modules.base.entity.User;
import com.tianbo.smartcity.modules.base.service.DepartmentHeaderService;
        ...
        for (FlowElement element : elements) {
            if (element.getId().equals(sequenceFlow.getTargetRef())) {
                if (element instanceof UserTask) {
                    ...
                    throw new SmartCityException("流程设计错误，开始节点后只能是用户任务节点");
                }
            }
        }
        ...
        for (ActivityImpl activityImpl : activitiList) {
            if (activityImpl.getId().equals(currActId)) {
                ...
                if ("userTask".equals(type)) {
                    ...
                    throw new SmartCityException("流程设计错误，包含无法处理的节点");
                }
                break;
            }
        }
