...
import com.tianbo.smartcity.config.activiti.ActivitiExtendProperties;
...
import com.tianbo.smartcity.modules.activiti.vo.HistoricProcessInsVo;
import com.tianbo.smartcity.modules.activiti.vo.ProcessInsVo;
import com.tianbo.smartcity.modules.activiti.vo.ProcessNodeVo;
...
@RequestMapping("/smartcity/actProcess")
@Transactional
public class ActProcessInsController {
    ...
    public void getHighlightImg(@ApiParam("流程实例id") @PathVariable String id,
        ...
        try {
            ...
            throw new SmartCityException("读取流程图片失败");
        }
    }
