package com.tianbo.smartcity.modules.activiti.controller.business;
...
@Transactional
@RequestMapping(value = "/smartcity/leave")
public class LeaveController extends SmartCityBaseController<Leave, String> {
