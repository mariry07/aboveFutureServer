...
import com.tianbo.smartcity.modules.activiti.service.ActModelService;
...
@RequestMapping(value = "/smartcity/actModel")
@Transactional
public class ActModelController {
    ...
    public void export(@PathVariable String id, HttpServletResponse response) {
        ...
        try {
            ...
            if (nodeBytes == null) {
                throw new SmartCityException("导出失败，模型数据为空");
            }
            ...
            log.error(e.toString());
            throw new SmartCityException("导出模型出错");
        }
    }
