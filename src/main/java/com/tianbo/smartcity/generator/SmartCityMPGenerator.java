package com.tianbo.smartcity.generator;

import com.tianbo.smartcity.generator.bean.Entity;
...
import static com.tianbo.smartcity.generator.SmartCityGenerator.*;
 ...
 */
@Slf4j
public class SmartCityMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.tianbo.smartcity.modules.your.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.tianbo.smartcity.modules.your.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.tianbo.smartcity.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.tianbo.smartcity.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.tianbo.smartcity.modules.your.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/cn/exrick/smartcity/generator/template";
