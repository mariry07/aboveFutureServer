package com.tianbo.smartcity.generator.vue;
...
import com.tianbo.smartcity.generator.bean.Field;
...
@RequestMapping(value = "/smartcity/generate")
public class SmartCityVueGenerator {
    ...
    public String generate(String template, String vueName, Integer rowNum, List<Field> fields) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir") + "/src/main/java/cn/exrick/smartcity/generator/vue";
        ...
        if (rowNum == 1) {
            ...
            throw new SmartCityException("rowNum仅支持数字1-4");
        }
        // 生成代码
