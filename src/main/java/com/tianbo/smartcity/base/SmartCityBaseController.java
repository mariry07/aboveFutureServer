package com.tianbo.smartcity.base;
...
public abstract class SmartCityBaseController<E, ID extends Serializable> {
     ...
     */
    @Autowired
    public abstract SmartCityBaseService<E, ID> getService();
