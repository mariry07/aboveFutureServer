...
public class FileUtil {
    ...
    public OssSetting getOssSetting() {
        ...
        if (StrUtil.isBlank(v)) {
            throw new SmartCityException("您还未配置本地文件存储服务");
        }
    ...
    public String localUpload(MultipartFile file, String key) {
        ...
        if (f.exists()) {
            throw new SmartCityException("文件名已存在");
        }
        try {
            file.transferTo(f);
            return path + "/" + key;
            ...
            throw new SmartCityException("上传文件出错");
        }
    }
    ...
    public void view(String url, HttpServletResponse response) {
        ...
        try {
            ...
            log.error(e.toString());
            throw new SmartCityException("读取文件出错");
        }
    }
    ...
    public String copyFile(String url, String toKey) {
        ...
        try {
            ...
            log.error(e.toString());
            throw new SmartCityException("复制文件出错");
        }
    }
