...
public class QiniuUtil {
    ...
    public OssSetting getOssSetting() {
        ...
        if (StrUtil.isBlank(v)) {
            throw new SmartCityException("您还未配置七牛云OSS");
        }
    ...
    public String qiniuUpload(String filePath, String key) {
        ...
        try {
            ...
            throw new SmartCityException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String renameFile(String fromKey, String toKey) {
        ...
        try {
            ...
            throw new SmartCityException("重命名文件失败，" + ex.response.toString());
        }
    }
    ...
    public String copyFile(String fromKey, String toKey) {
        ...
        try {
            ...
            throw new SmartCityException("复制文件失败，" + ex.response.toString());
        }
    }
    ...
    public void deleteFile(String key) {
        ...
        try {
            ...
            throw new SmartCityException("删除文件失败，" + ex.response.toString());
        }
    }
}