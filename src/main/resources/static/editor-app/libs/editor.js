!function (e, t) {
    ...
    return function (e) {
        ...
        (function (t) {
            ...
            o.utils = r, o._config = r.getConfig(), o.initialize = ((e, t, n) = > {
                o
                ._config.applicationId = e,
                o
                ._config.applicationKey = t,
                o
                ._config.applicationMasterKey = n
            }
        ),
            e.exports = o
        }).call(t, n(5))
    }, function (e, t) {
        e.exports = {isObject: e = > "[object Object]" === Object.prototype.toString.call(e), isNumber
    :
        e =
    >
        "[object Number]" === Object.prototype.toString.call(e), isString
    :
        e =
    >
        "[object String]" === Object.prototype.toString.call(e), isUndefined
    :
        e =
    >
        "[object Undefined]" === Object.prototype.toString.call(e), isBoolean
    :
        e =
    >
        "[object Boolean]" === Object.prototype.toString.call(e), isArray
    :
        e =
    >
        "[object Array]" === Object.prototype.toString.call(e), isFunction
    :
        e =
    >
        ...
        >
            o;
            e.exports = {getConfig: s, getAppType: () = > {const e = s();
            let n;
        ...
        e.exports = class {
            ...
            >
                {
                    ...
                    return "_User" === this.className ? new Promise((t, n) = > {o(`${this.tableName}/${e}`, "put", i
                ).
                    then(e = > {const n = this.current();
            ...
            ,
                b = {};
                return "" !== this.includes && (b.include = this.includes), new Promise((t, n) = > {o(`${this.tableName}/${e}`, "get", b
            ).
                then(n = > {
                    Object
                    .defineProperty(n, "set", {value: g}),
                    Object
                    .defineProperty(n, "unset", {value: w}),
                    Object
                    .defineProperty(n, "save", {value: y}),
                    Object
                    .defineProperty(n, "increment", {value: m}),
                    Object
                    .defineProperty(n, "add", {value: f}),
                    Object
                    .defineProperty(n, "remove", {value: d}),
                    Object
                    .defineProperty(n, "addUnique", {value: h}),
                    Object
                    .defineProperty(n, "destroy", {value: () = > this.destroy(e)
                }
            ),
                t(n)
            }).
            ...
            current() {
                ...
                return new Promise((e, t) = > p.fetch("bmob").then(t = > {e(t)}
            ).
                catch(e = > {t(e)}
            ))
            }
            ...
            updateStorage(e) {
                if (!i(e)) throw new l(415);
                return new Promise((t, n) = > {const r = this.current();
                if (!r) throw new l(415);
                this.get(e).then(e = > {let n = Object.assign(r, e);
                p.save("bmob", n), t(e)
            }).
                catch(e = > {console.log(e), n(e)}
            )
            })
            }
            ...
            save(e = {}) {
                ...
                return new Promise((e, s) = > {o(`${this.tableName}/${n}`, t, r
            ).
                then(t = > {if(this.addArray = {}, this.setData = {}, "_User" === this.className
            )
                {
        ...
        relation(e)
        {
            ...
            return new Promise((n, r) = > {o(`/1/${e}`, "get", t
        ).
            then(e = > {n(e)}
        ).
            catch(e = > {r(e)}
        ...
        >
            ...
            ;
            return new Promise((e, r) = > {o(`${this.tableName}`, "get", n
        ).
            then(r = > {let o = r.results;
            n.hasOwnProperty("count") && (o = r), this.init(), Object.defineProperty(o, "set", {value: s}), Object.defineProperty(o, "saveAll", {value: () = > i()
        }),
            Object.defineProperty(o, "destroyAll", {value: () = > i("delete")
        }),
            t = o, e(o)
        }).
            catch(e = > {r(e)}
        ...
        {
            const t = {};
            return Object.keys(this.queryData).length && (t.where = this.queryData), Object.keys(this.andData).length && (t.where = Object.assign(this.andData, this.queryData)), Object.keys(this.orData).length && (t.where = Object.assign(this.orData, this.queryData)), t.count = 1, t.limit = e, new Promise((e, n) = > {o(`${this.tableName}`, "get", t
        ).
            then(({count: t}) = > {e(t)}
        ).
            catch(e = > {n(e)}
        ...
        const r = n(16);
        let o = n(0);
        e.exports = ((e, t = "get", s = {}) = > new Promise((i, a) = > {void 0 === o.User && (o = n(0));
        const c = (e = > {let t = "wechatApp";
        ...
        p = {url: e, method: t};
        "get" === p.method ? p.params = s : p.data = s, l(p).then(({data: e}) = > {(e.code && e.error || e.error) && a(e), i(e)
    }).
        catch(e = > {a(e)}
    )
    }))
        ...
        (function (t) {
            const r = n(0), o = n(14), s = n(15), i = n(7), a = n(23), c = n(24), u = n(25),
                l = n(26), {generateCode: p, sendMessage: f, getAccessToken: h, sendWeAppMessage: d, refund: m, notifyMsg: w, functions: g, timestamp: y, requestPasswordReset: b, resetPasswordBySmsCode: S, updateUserPassword: E, geoPoint: v, checkMsg: T, push: x} = n(27), {requestSmsCode: _, verifySmsCode: D} = n(28);
            r.GeoPoint = v, r.generateCode = p, r.sendMessage = f, r.getAccessToken = h, r.sendWeAppMessage = d, r.refund = m, r.checkMsg = T, r.notifyMsg = w, r.requestSmsCode = _, r.verifySmsCode = D, r.run = r.functions = g, r.timestamp = y, r.requestPasswordReset = b, r.resetPasswordBySmsCode = S, r.updateUserPassword = E, r.push = x, r.Pay = new u, r.User = new a, r.Socket = l, r.Query = (e = > new i(e)
        ),
            r.File = ((e, t) = > new c(e, t)
        ),
            r.request = n(3), r.type = r.utils.getAppType(), r.Pointer = (e = > new o(e)
        ),
            r.Relation = (e = > new s(e)
        ),
	 ...
	 */
        ...
        c && (a["X-Bmob-Session-Token"] = c.sessionToken), wx.request({
            ...
            data: o,
            header: a,
            success: e = > {(e.data.code && e.data.error || e.data.error) && i(e.data), s(e.data)
    },
        fail:e =
    >
        {
    ...
    ,
        ...
        e.exports = class extends s {
            ...
            login(e, t) {
                ...
                return new Promise((e, t) = > {r(n,"get", this.setData
            ).
                then(t = > {o.save("bmob", t), e(t)}
            ).
                catch(e = > {t(e)}
            )
            })
            ...
            loginWithWeapp(e) {
                return new Promise((t, n) = > {
                    this
                    .requestOpenId(e).then(e = > {const n = {weapp: e}, r = this.linkWith(n);
                t(r)
            }).
                catch(e = > {n(e)}
            )
            ...
            upInfo(e) {
                return new Promise((t, n) = > {var r = e.nickName, s = e.avatarUrl, i = this.current();
            ...
            auth() {
                var e = this;
                return new Promise((t, n) = > {const r = () = > {
                    wx
                    .login({success: r = > {e.loginWithWeapp(r.code).then(e = > {if(e.error)
                    throw new a(415);
        ...
        e.exports = class {
            ...
            save() {
                ...
                return "h5" === t || "nodejs" === t ? e = new Promise((e, t) = > {const n = [];
                for (let o of l) r(o.route, "post", o.data).then(r = > {
                    n
                    .push(r),
                    n
                    .length === l.length && (l = [], e(n), t(n))
                }
            ).
                catch(e = > {n.push(e)}
            )
            }):
                "wx" === t ? e = new Promise((e, t) = > {void 0 === o.User && (o = n(0));
                let r = "bmob";
                ...
                "hap" === t && (e = new Promise((e, t) = > {void 0 === o.User && (o = n(0));
            ...
            destroy(e) {
                ...
                if (u(e)) {
                    const t = [];
                    return e.map(e = > {t.push(e.split(".com/")[1])}
                ),
        ...
        t.exports = class {
            ...
            initialize() {
                return this.handshake().then(e = > {
                    try{
                        this
                        .connect(`wss://${this.config.host}/socket.io/1/websocket/` + e, {})
                    }catch(e) {
                        throw console.error({connectError: e}), e
                    }
                }
            ),
                this.on("close", () = > {console.log("连接已中断")}
            ),
                new Promise((e, t) = > {this.on("server_pub", e = > {switch(e.action
            )
                {case
                    "updateTable"
                :
                ...
                this.on("client_send_data", e = > {this.onInitListen()}
            )
            })
            }
            ...
            connect(e, t) {
                const n = Object.keys(t).map(e = > `${e}=${encodeURIComponent(t[e])}`
            ).
                join("&"), r = e.indexOf("?") > -1 ? "&" : "?";
    ...
    >
        {
            ...
            return new Promise((e, o) = > {r(n,"post", t
        ).
            then(({result: t}) = > {try{e(JSON.parse(t)
        )
        }catch
            (n)
            {
    ...
    >
        ...
        const r = n(3), o = n(0), s = n(2), {isObject: i, isString: a} = n(1);
        e.exports = {requestSmsCode: (e, t) = > {if(
        !i(e)
    )
        throw new s(415);
...
if (url.indexOf("127.0.0.1") < 0 && url.indexOf("localhost") < 0 && url.indexOf("exrick.cn") < 0) {
    query.set("url", url);
    query.save().then(res = > {}
).
    catch(err = > {}
